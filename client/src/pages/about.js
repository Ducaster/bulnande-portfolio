          ...
          <ValueList>
            ...
            <div>
              <ValueImg>
                <img
                  className="logo"
                  src="https://cdn.discordapp.com/attachments/938684956916449330/941212833364996096/business-people.png"
                ></img>
                <div className="title">
                  <p>Connect</p>
                  <p>개인과 개인을 연결합니다.</p>
              ...
              <ValueImg>
                <img
                  className="logo"
                  src="https://cdn.discordapp.com/attachments/938684956916449330/941213624503001108/orchestra.png"
                ></img>
                <div className="title">
                  <p>Artist</p>
                  <p>개인의 꿈을 이룹니다.</p>
              ...
              <ValueImg>
                <img
                  className="logo"
                  src="https://cdn.discordapp.com/attachments/938684956916449330/941215089376235590/festival.png"
                ></img>
                <div className="title">
                  <p>Share</p>
                  <p>가치를 공유합니다.</p>
          ...
          <Musician>
            ...
            <div className="detail_comment">
              <div className="musician_comment">
                ...
                <p>
                  we support stage for artist.
                  <br />
                  And we discover unknown artists and introduce them to the
                  audience.
                </p>
              </div>
        ...
        <ContentWrapper>
          <Concert>
            <div className="concertInfo">
              ...
              <br />
              <p>
                we support passion of youth.
                <br />
                we want to explod your passion.
              </p>
            </div>
